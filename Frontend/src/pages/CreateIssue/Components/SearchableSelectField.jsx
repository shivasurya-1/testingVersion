  ...
  return (
    <div className="space-y-1">
      ...
      <div className="relative" ref={dropdownRef}>
        <div
          className={`h-9 w-full px-3 pr-8  bg-white border text-black border-gray-300 flex items-center justify-between cursor-pointer transition-all ${
            disabled ? "opacity-50 pointer-events-none" : ""
          } ${error ? "border-red-500" : "focus-within:border-emerald-500"}`}
          onClick={toggleDropdown}
        >
          <span className="truncate">
            {getSelectedLabel() || `Select  Automatic`}
          </span>
        ...
        {isOpen && (
          <div className="absolute z-50 w-full mt-1 bg-white border border-gray-300  shadow-lg max-h-60 overflow-y-auto">
            ...
            <div className="sticky top-0 bg-white p-2 border-b border-gray-200">
              <input
                type="text"
                className="w-full p-2 pl-10 text-gray-800  bg-white border border-gray-300 focus:outline-none focus:ring-1 focus:ring-emerald-500"
                placeholder="Search..."
                value={searchTerm}
